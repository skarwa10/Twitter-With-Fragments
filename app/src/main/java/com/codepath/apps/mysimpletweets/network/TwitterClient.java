...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "yLYuXzYfTSszObkZCB8cHuczj";
	public static final String REST_CONSUMER_SECRET = "Sd0bBFSni7AablNNOHxhjRkWTjOpxVkaNdTfuqnSr3IUpGjAZD";
	...
	public void getUserTimeline(AsyncHttpResponseHandler handler){
		...
		RequestParams params = new RequestParams();
		params.put("count", "1");
		params.put("screen-name","sonalikarwa");
		client.get(apiUrl,params, handler);
	}
